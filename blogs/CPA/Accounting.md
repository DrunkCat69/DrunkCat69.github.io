...
| <span style="display:inline-block;width:500px">采用成本模式进行后续计量的投资性房地产：<br />账面余额 = 账面原价<br />账面净值 = 账面余额 - 投资性房地产累计折旧（摊销）<br />账面价值 = 账面余额 - 投资性房地产累计折旧（摊销）- 投资性房地产减值准备 </span> | <span style="display:inline-block;width:500px">采用公允价值模式进行后续计量的投资性房地产：<br />采用公允价值模式进行后续计量的投资性房地产由于==不计提折旧、不摊销、不计提减值准备==，所以其账面余额 = 账面价值（fair value)</span> |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
